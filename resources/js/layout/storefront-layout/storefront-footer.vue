...
<template>
    <footer class="bg-white dark:bg-info">
        <div class="px-4 container max-w-screen-xl mx-auto py-6">
            ...
            <hr class="my-2 border-gray-200 md:my-8 dark:border-gray-700">

            <div class="flex items-center justify-between">
                <div class="mw-full w-14 mr-auto"><Logo/></div>
                <p class="mx-2 text-base font-normal leading-7 text-center text-grey-700">©
                    2023 Brand Teach. All rights reserved.</p>
