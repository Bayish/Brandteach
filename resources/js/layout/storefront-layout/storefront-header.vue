...
<template>
    ...
    <header class="bg-white h-24">
        <nav class="px-4 xl:px-0 container w-full h-full mx-auto flex items-center justify-between py-4" aria-label="Global">
            ...
            <div
               ...
               >
                <div class="relative"  @mouseover="toggleMenu(true)"
                    ...
                    <div
                        ...
                        class="absolute right-0 top-full mt-1 w-screen max-w-sm overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 duration-300 ease-in-out">
                        <div class="p-4">
                            <div
                                ...
                                <div class="flex-auto">
                                    ...
                                    <p class="mt-1 text-gray-600">Если вы студент, пожалуйста, войдите здесь</p>
                                </div>
                            </div>
                            <div
                                class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                                ...
                                <div class="flex-auto">
                                    <a href="/login" class="block font-semibold text-gray-900">
                                        Вход для учителей и партнёров
                                        <span class="absolute inset-0"></span>
                                    </a>
                                    <p class="mt-1 text-gray-600">Если вы учитель или партнёр, вы можете войти здесь</p>
                                </div>
                            </div>
                        </div>
