                ...
                <div class="grid grid-cols-1 gap-10 mt-20 lg:grid-cols-3 md:grid-cols-2">
                    <div class="flex flex-col items-center col-span-1 gap-6 px-10 py-8 hover:bg-white hover:shadow-main rounded-3xl">
                        ...
                        <div class="flex flex-col gap-2 px-2 text-center">
                            <h4 class="text-2xl font-extrabold text-info font-display">Streamline Team Communication</h4>
                            <p class="font-medium text-secondary">Streamline communication within your team using our shared team inboxes. Enhance collaboration and keep everyone on the same page effortlessly.</p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center col-span-1 gap-6 px-10 py-8 hover:bg-white hover:shadow-main rounded-3xl">
                        <div>
                        ...
                        <div class="flex flex-col gap-2 px-2 text-center">
                            <h4 class="text-2xl font-extrabold text-info font-display">Gain Insights with Analytics</h4>
                            <p class="font-medium text-secondary">Gain valuable insights and data analytics for your team through our analytics dashboard. Make informed decisions and track your progress effectively.</p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center col-span-1 gap-6 px-10 py-8 hover:bg-white hover:shadow-main rounded-3xl">
                        <div>
                        ...
                        <div class="flex flex-col gap-2 px-2 text-center">
                            <h4 class="text-2xl font-extrabold text-info font-display">Provide Instant Solutions</h4>
                            <p class="font-medium text-secondary">Deliver instant answers to your customers or team members with our shared team inboxes. Ensure quick responses and efficient problem-solving.</p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center col-span-1 gap-6 px-10 py-8 hover:bg-white hover:shadow-main rounded-3xl">
                        <div>
                        ...
                        <div class="flex flex-col gap-2 px-2 text-center">
                            <h4 class="text-2xl font-extrabold text-info font-display">Enhance Customer Connections</h4>
                            <p class="font-medium text-secondary">Connect with your customers seamlessly using our shared team inboxes. Improve customer interactions and build stronger relationships.</p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center col-span-1 gap-6 px-10 py-8 hover:bg-white hover:shadow-main rounded-3xl">
                        <div>
                        ...
                        <div class="flex flex-col gap-2 px-2 text-center">
                            <h4 class="text-2xl font-extrabold text-info font-display">Seamless Web Integration</h4>
                            <p class="font-medium text-secondary">Integrate our shared team inboxes seamlessly with your website. Enhance the user experience and provide efficient communication channels. </p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center col-span-1 gap-6 px-10 py-8 hover:bg-white hover:shadow-main rounded-3xl">
                        <div>
                        ...
                        <div class="flex flex-col gap-2 px-2 text-center">
                            <h4 class="text-2xl font-extrabold text-info font-display">Effortless Team Management</h4>
                            <p class="font-medium text-secondary">Manage your team effortlessly with our shared team inboxes. Simplify team reporting and ensure smooth operations. </p>
                        </div>
                    </div>
                </div>
            </div>
