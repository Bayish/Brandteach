<template>
    <div class="carousel overflow-x-auto relative">
        <div
            class="flex flex-nowrap overflow-x-auto carousel-inner flex transition-transform ease-in-out duration-500"
        >
            <div
                class="max-w-sm bg-white px-4 py-6 rounded-xl shadow-lg transform hover:scale-105 transition duration-500 flex flex-col
                carousel-item w-full flex-shrink-0 p-4 bg-white rounded-lg shadow-md
                "
