...
<template>
    <div class="container flex flex-col mx-auto draggable" draggable="true">
        ...
        <div class="grid w-full grid-cols-1 my-auto mt-12 mb-8 md:grid-cols-2 xl:gap-14 md:gap-5">
            <div class="flex flex-col justify-center col-span-1 text-center lg:text-start">
                <div class="flex items-center justify-center mb-4 lg:justify-normal">
                    ...
                    <h4 class="ml-2 text-sm font-bold tracking-widest text-primary uppercase">your journey starts here</h4>
                </div>
                <h1 class="mb-8 text-4xl font-extrabold leading-tight lg:text-6xl text-dark-grey-900">The world of startups is here</h1>
