    ...
    <header class="bg-white">
        <nav class="mx-auto flex container items-center justify-between py-4" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end items-center">
                <a :href="route('login')" class="btn btn-accent rounded-full shadow-none text-base font-semibold text-info">Log in</a>
                <a href="#" class="btn btn-primary rounded-full shadow-none ml-2 text-base font-semibold text-accent">Sign up</a>
            </div>
        </nav>
    </header>
    <div class="min-h-screen h-full flex flex-col">
        <div class="flex-1 flex flex-col h-full">
            <div class="container py-10 h-full flex flex-col flex-1 mx-auto">
                <div class="w-full flex">
                    <div class="w-7/12 flex flex-col justify-center col-span-1 text-center lg:text-start">
                        ...
                        <p class="mb-6 text-base font-normal leading-7 lg:w-3/4 text-grey-900">
                            Для того чтобы учиться, вам не обязательно куда-то ехать. Вы можете найти все здесь и обучаться онлайн с лучшими наставниками. Всерьез.
                        </p>
                    ...
                    <div class="w-5/12 items-center justify-end hidden col-span-1 md:flex">
            ...
            <div class="container flex flex-col items-center gap-8 mx-auto my-32">
                <p class="text-base font-medium leading-7 text-center text-dark-grey-600">Эти компании используют нашу платформу</p>
                <div
            ...
            <div class="container mx-auto" draggable="true">
                <div class="flex flex-col items-center justify-center h-full bg-primary rounded-xl shadow-md">

                    <div class="flex flex-col items-center justify-center mt-12">
                        <h2 class="mb-4 text-3xl font-extrabold leading-tight text-center lg:text-4xl text-info">
