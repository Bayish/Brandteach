            ...
            <div class="overflow-x-auto">
              <table class="w-full my-0 align-middle text-dark border-neutral-200">
                ...
                <tr class="font-semibold text-[0.95rem] text-secondary-dark">
                  ...
                  <th class="pb-3 text-start min-w-[100px]">Teacher</th>
                  <th class="pb-3 text-end min-w-[100px]">Start</th>
                  <th class="pb-3 pr-12 text-end min-w-[175px]">Realized</th>
                  <th class="pb-3 pr-12 text-end min-w-[100px]">DEADLINE</th>
                  <th class="pb-3 text-end min-w-[50px]">DETAILS</th>
                </tr>
                </thead>
                <tbody>
                  <tr class="border-b border-dashed last:border-b-0" v-for="i in 10">
                  <td class="p-3 pl-0">
